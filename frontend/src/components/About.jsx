        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card className="bg-slate-900/70 border-red-500/30 backdrop-blur-sm shadow-lg shadow-red-500/10">
                <CardContent className="p-6 text-center">
                  ...
                  <h4 className="font-semibold text-gray-200 mb-2">Missão</h4>
                  <p className="text-sm text-gray-400">Dominar através de soluções elegantes e poderosas</p>
                </CardContent>
              </Card>

              <Card className="bg-slate-900/70 border-red-500/30 backdrop-blur-sm shadow-lg shadow-red-500/10">
                <CardContent className="p-6 text-center">
                  <Lightbulb className="h-8 w-8 text-orange-400 mx-auto mb-3" />
                  <h4 className="font-semibold text-gray-200 mb-2">Filosofia</h4>
                  <p className="text-sm text-gray-400">Conhecimento é poder absoluto</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center">
              <blockquote className="text-2xl font-light text-red-300 italic">
                "{developerInfo.quote}"
              </blockquote>
            </div>
          </div>
